      ...
      <div style={{ background: '#FFFFFF', padding: '90px 64px 60px' }}>
        <div style={{ maxWidth: 1240, margin: '0 auto', display: 'grid', gridTemplateColumns: '1.05fr 0.95fr', gap: 64, alignItems: 'center' }}>
          <div style={{ animation: 'std-rise 0.7s ease-out both' }}>
            ...
            <p style={{ fontSize: 15, color: '#3C403D', lineHeight: 1.8, margin: '0 0 18px' }}>Founded in the United States by a visionary facilities management entrepreneur, our company has grown into one of the nation's largest service organizations. Today, we oversee more than 16,000 employees and a network of over 4,000 independent service providers, delivering comprehensive facility solutions across all 50 states.</p>
            <p style={{ fontSize: 15, color: '#3C403D', lineHeight: 1.8, margin: 0 }}>We specialize in healthcare, education, retail, and multifamily housing - industries where quality, consistency, safety, and accountability are essential.</p>
          </div>
  ...
  return (
    <div style={{ width: '100%', maxWidth: 560, margin: '0 auto', background: '#FFFFFF', fontFamily: "'Poppins',sans-serif", color: '#111412', overflowX: 'hidden', position: 'relative' }}>
      ...
      <div style={{ background: '#FFFFFF', padding: '44px 20px 8px', textAlign: 'center' }}>
        ...
        <p style={{ fontSize: 14, color: '#3C403D', lineHeight: 1.75, margin: '0 0 14px', textAlign: 'left' }}>Founded in the United States by a visionary facilities management entrepreneur, our company has grown into one of the nation's largest service organizations. Today, we oversee more than 16,000 employees and a network of over 4,000 independent service providers, delivering comprehensive facility solutions across all 50 states.</p>
        <p style={{ fontSize: 14, color: '#3C403D', lineHeight: 1.75, margin: '0 0 24px', textAlign: 'left' }}>We specialize in healthcare, education, retail, and multifamily housing - industries where quality, consistency, safety, and accountability are essential.</p>
